...
class LeftTurn(gym.Env):
    def __init__(self, enabled_obs_number=3, vehicle_type = 'random',
        ...
        self.observation_space = spaces.Box(low=0, high=1, shape=(3,HEIGHT, WIDTH), dtype=np.float16)
    ...
    def reset(self):
        ...
        bp_viz_camera.set_attribute('fov', '105')
        ...
        bp_seman_camera.set_attribute('fov', '105')
